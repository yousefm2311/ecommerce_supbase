...
import 'package:ecommerce_supbase/features/inrider_passengers/presentation/view/widgets/list_view_card_details.dart';
import 'package:flutter/material.dart';

class InriderPassengerView extends StatelessWidget {
  const InriderPassengerView({super.key});

  @override
  Widget build(BuildContext context) {
    final size = AppMediaQuery.of(context).size.width;
    return Scaffold(
      appBar: AppBar(title: const Text(AppStrings.inriderpassenger)),
      body: Padding(
        padding: EdgeInsets.symmetric(horizontal: size * .05),
        child: Column(
          children: [
            const Expanded(child: ListViewCardDetails()),
